...
public class DemoDataLoader {
	...
	listMenuItemEntity.add(new MenuItemEntity("Salad", "Dressing,Bill's Blue Cheese Dressing",MenuType.SALAD_DRESSING,Category.VEGAN,Arrays.asList("honey","sause","mustard"),"",null,MenuItemStatus.CURRENT));
	...
	listMenuItemEntity.add(new MenuItemEntity("Vegan Brownies","Vegan Brownies",MenuType.DESSERT,Category.VEGITERIAN,Arrays.asList("flour","sugar", "cocoa powder", "baking powder","salt"),"",null,MenuItemStatus.SUGGESTED));
	...
	listMenuItemEntity.add(new MenuItemEntity("Macaroni","Baked Macaroni and Cheese",MenuType.MAIN_COURSE,Category.VEGITERIAN,Arrays.asList("macaroni","milk"),"",null,MenuItemStatus.SUGGESTED));
    ...
    public static List<UserEntity> getDemoUserEntity(){
        ...
        listUserEntity.add(new UserEntity("Mark","Mark@mum.edu","Mark",UserRole.CUSTOMER));
        listUserEntity.add(new UserEntity("Nancy","Nancy@mum.edu","Nancy",UserRole.CUSTOMER));
        listUserEntity.add(new UserEntity("David","David@mum.edu","David",UserRole.CUSTOMER));
